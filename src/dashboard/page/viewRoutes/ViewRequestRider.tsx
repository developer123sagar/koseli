  ...
  return (
    <div className="mt-20 w-full">
      ...
      <div className="my-16">
        ...
        <div className="w-full flex gap-x-5 justify-between">
          <div>
            ...
            <img
              src={`${baseImgUrl}/${selectedItem?.insurance?.document}`}
              alt={selectedItem?.insurance?.insuranceNumber}
              className="w-[20rem] object-cover"
            />
          </div>
        </div>
      ...
      <div className="mt-6">
        ...
        <img
          src={`${baseImgUrl}/${selectedItem?.contractDoc}`}
          alt={selectedItem?.rider?.name}
          className="w-[20rem] object-cover"
        />
      </div>
